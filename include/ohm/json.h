...
namespace ohm {
    ...
    namespace json {
        ...
        std::function<void(const Var &)> parser(T *value) {
        ...
        template<typename T, typename = typename std::enable_if<support_base_parser<T>::value>::type>
        std::function<void(const Var &)> parser(const std::string &name, T *value) {
        ...
        std::function<void(const Var &)> parser(T *value, const T &default_value) {
        ...
        template<typename T, typename = typename std::enable_if<support_parser_with_default<T>::value>::type>
        std::function<void(const Var &)> parser(const std::string &name, T *value, const T &default_value) {
